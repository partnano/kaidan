...
function SimulationHandler:load ()
   
   self.world = lp.newWorld (0, 0, true)

end

function SimulationHandler:spawn (x, y)
...
function SimulationHandler:prepare_select (x, y)
...
function SimulationHandler:select (x, y)
...
function SimulationHandler:add_to_move_queue (selected_ids, x, y)
...
function SimulationHandler:move (ds, cs)
...
function SimulationHandler:draw ()
   ...
   if love.mouse.isDown (1) and self.selection.active then
      ...
      local _x2 = mx - self.selection.x
      local _y2 = my - self.selection.y
...
function SimulationHandler:update (dt, dts)
